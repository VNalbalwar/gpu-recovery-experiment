...
constexpr int RECOVERY_SAMPLES = 20;
...
int main(int argc, char **argv)
{
    ...
    std::cout
        << "\n============================================\n"
        << " Paired High-Resolution L2 Recovery Experiment\n"
        << "============================================\n\n"
        << "GPU:                 " << prop.name << "\n"
        << "SM count:            "
    ...
    // Fixed seed makes the ordering reproducible.
         ...
         ++trial)
    {
        ...
        {
            std::cout
                << "Starting 100 ms L2 interference...\n";
